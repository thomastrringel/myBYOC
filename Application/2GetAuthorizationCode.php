<?php
    ...
    setcookie("vin", "put-your-vin-here", time()+3600, "/mb/", ""); // speichere $vin als Cookie für 1h speichern - nur zu Testzwecken (ohne Funktion)
    ...
    $client_secret = 'out-your-client-secret-here';
    $redirect_uri = 'https://put-your-domain-name-here/2GetAuthorizationCode.php';  // add this filename here
    ...
    function getAccessToken() {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://id.mercedes-benz.com/as/token.oauth2');
